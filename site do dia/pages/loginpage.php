            ...
            <div id="grid">
                ...
                <form action="../backend/acesso.php">
                          <div class="form-item">
                            ...
                            <label id="legal" for="nice2">E-mail ou telefone</label>
                            </div>
                            <div class="form-item">
                         ...
                         <input id="submitar" value="Acessar conta" type="submit">
                         <div id="acess"><a href="createaccount.php"><p>Não tenho conta</p></a></div>
                </form>
            </div>
        </div>
    </div>
